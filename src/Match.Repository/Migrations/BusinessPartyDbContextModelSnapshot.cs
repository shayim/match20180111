...
namespace Match.Repository.Migrations
{
    ...
    partial class BusinessPartyDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Match.Domain.Common.PartyBase.SocialMediaAccount", b =>
                {
                    ...
                    b.HasKey("PersonId", "TypeId", "Account");
            ...
            modelBuilder.Entity("Match.Domain.BusinessParties.SalesPerson", b =>
                {
                    b.HasOne("Match.Domain.Common.Business.Employee", "Employee")
                        .WithOne()
                        .HasForeignKey("Match.Domain.BusinessParties.SalesPerson", "Id")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("Match.Domain.Common.PartyBase.PartyContact", b =>
                {
                    b.HasOne("Match.Domain.Common.PartyBase.Person", "Contact")
                        .WithMany()
            ...
            modelBuilder.Entity("Match.Domain.Common.PartyBase.SocialMediaAccount", b =>
                {
                    ...
                    b.HasOne("Match.Domain.Common.PartyBase.SocialMediaType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
